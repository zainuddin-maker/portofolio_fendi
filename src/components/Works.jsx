...
const ProjectCard = ({
    ...
    return (
        <motion.div variants={textVariant()}>
          ...
          /> */}
                    <ImageSwapper images={image} name={name} />
                ...
                <div className='mt-5'>
                    <h3 className='text-white font-bold text-[24px] dark:text-neutral-900'>
                        {name}
                    </h3>
...
const Works = () => {
    return (
        <>
            <motion.div variants={textVariant()}>
                <p className={`${styles.sectionSubText} dark:text-neutral-900`}>
                    What I have built
                </p>
                <h2
