      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] mx-auto flex flex-row items-start gap-5 max-w-7xl`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} dark:text-neutral-800`}>
            Hi, I'm
            <span style={{color: dark ? "#FF0000":"#0D7377"}}> Fendi</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100 dark:text-neutral-800`}>
            Full-stack Software Developer specialized in building scalable Web Applications (2D and 3D) and Mobile Application using React,React Native,NextJS,Three Js,Express Js,PostgreSQL.
          </p>
        </div>
      </div>
      <ComputersCanvas dark={dark}/>
