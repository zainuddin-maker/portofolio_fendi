    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <div className='logo-for-fendi dark:text-neutral-800'style={{fontSize:"25px"}}>
            {"{Z.E.R}"}
          </div>
          ...
          {/* <p className="sm:block hidden text-white text-[20px] font-bold cursor-pointer dark:text-neutral-800" style={{display:"inline-block"}}>
            {"<zainuddinEfendi/>"}
          </p> */}
        </Link>
